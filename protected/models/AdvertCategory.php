 ...
 * @property CategoryParam[] $_categoryParams
 */
class AdvertCategory extends CActiveRecord
{
  public $_categoryParams;
  /**
  ...
  public function relations()
  {
    ...
    return array(
        ...
        'categoryParams' => array(self::HAS_MANY, 'CategoryParam', 'id_category'),
    );
  }
  ...
  public function hasParam($id_param)
  {
    $params = $this->getCategoryParams();
    return !empty($params[$id_param]) && $params[$id_param]->enabled;
  }

  public function getCategoryParams()
  {
    $params = $this->initCategoryParams();
    return $params;
  }

  public function initCategoryParams()
  {
    if(empty($this->_categoryParams)) {
      $this->_categoryParams = array();
    }
    foreach ($this->categoryParams as $param) {
      $this->_categoryParams[$param->id_param] = $param;
    }
